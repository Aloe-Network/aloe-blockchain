...
from aloe.server.server import ssl_context_for_server
from aloe.types.peer_info import PeerInfo
from aloe.util.block_tools import BlockTools
from aloe.util.ints import uint16
from aloe.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "aloe_full_node")
        await ws.send_str(payload)
