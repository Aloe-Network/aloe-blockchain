...
from aloe.protocols.full_node_protocol import RespondBlock
from aloe.server.server import AloeServer
from aloe.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSAloeConnection] = wallet.server.get_outgoing_connections()
