...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Aloe Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Aloe-Network/aloe-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.aloecoin.org/simple/ miniupnpc==2.1
python -m pip install -e . --extra-index-url https://pypi.aloecoin.org/simple/

echo ""
echo "Aloe blockchain install.sh complete."
echo "For assistance join us on Keybase in the #testnet chat channel:"
echo "https://keybase.io/team/aloe_network.public"
echo ""
echo "Try the Quick Start Guide to running aloe-blockchain:"
echo "https://github.com/Aloe-Network/aloe-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'aloe init' to begin."
