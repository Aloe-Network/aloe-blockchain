...
from aloe.util.misc import format_bytes
from aloe.util.misc import format_minutes
...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is not None:
        print(f"Total aloe farmed: {amounts['farmed_amount'] / units['aloe']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['aloe']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['aloe']}")
        print(f"Last height farmed: {amounts['last_height_farmed']}")
    else:
        print("Total aloe farmed: Unknown")
    ...
    print("Note: log into your key using 'aloe wallet show' to see rewards for each key")
