...
from aloe.cmds.configure import configure_cmd
from aloe.cmds.farm import farm_cmd
from aloe.cmds.init import init_cmd
from aloe.cmds.keys import keys_cmd
from aloe.cmds.netspace import netspace_cmd
from aloe.cmds.plots import plots_cmd
from aloe.cmds.show import show_cmd
from aloe.cmds.start import start_cmd
from aloe.cmds.stop import stop_cmd
from aloe.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage aloe blockchain infrastructure ({__version__})\n",
    epilog="Try 'aloe start node', 'aloe netspace -d 192', or 'aloe show -s'",
...
@cli.command("version", short_help="Show aloe version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs aloe daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from aloe.daemon.server import async_run_daemon
    import asyncio
