...
from aloe.wallet.puzzles.puzzle_utils import (
...
from aloe.wallet.secret_key_store import SecretKeyStore
from aloe.wallet.sign_coin_solutions import sign_coin_solutions
...
class Wallet:
    ...
    async def create_spend_bundle_relative_aloe(self, aloe_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if aloe_amount < 0:
            utxos = await self.select_coins(abs(aloe_amount), exclude)
        else:
        ...
        aloe_amount = spend_value + aloe_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": aloe_amount}]
