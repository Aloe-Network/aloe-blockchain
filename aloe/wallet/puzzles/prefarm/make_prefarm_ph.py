...
from aloe.util.condition_tools import parse_sexp_to_conditions
from aloe.util.ints import uint32

address1 = "aloet15gx26ndmacfaqlq8m0yajeggzceu7cvmaz4df0hahkukes695rss6lej7h"
address2 = "aloet1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"
...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_aloe += int_from_bytes(cvp.vars[1])
            print(
...
total_aloe = 0
print("Pool address: ")
total_aloe += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_aloe += make_puzzle(farmer_amounts)

assert total_aloe == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
