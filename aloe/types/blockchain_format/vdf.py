...
from aloevdf import create_discriminant, verify_n_wesolowski
...
from aloe.types.blockchain_format.sized_bytes import bytes32, bytes100
from aloe.util.ints import uint8, uint64
