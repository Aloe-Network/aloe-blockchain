...
from aloe.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from aloe.harvester.harvester import Harvester
from aloe.plotting.plot_tools import PlotInfo, parse_plot_info
from aloe.protocols import harvester_protocol
from aloe.protocols.farmer_protocol import FarmingInfo
...
from aloe.util.api_decorators import api_request, peer_required
from aloe.util.ints import uint8, uint32, uint64
from aloe.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSAloeConnection
    ):
        """
